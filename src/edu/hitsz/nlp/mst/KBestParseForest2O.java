...
import edu.hitsz.nlp.mst.BinaryHeap;
import edu.hitsz.nlp.mst.DependencyInstance;
import edu.hitsz.nlp.mst.FeatureVector;
import edu.hitsz.nlp.mst.ParseForestItem;
import edu.hitsz.nlp.mst.ValueIndexPair;
...
public class KBestParseForest2O {
    ...
    /** 带权重的，用于模型融合 &*/
    public Object[][] getBestParsesWithWeights() {
