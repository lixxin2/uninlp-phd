...
public class DependencyParser {
    ...
    public Object[] getBest(DependencyInstance instance) {    	
	    ...
	    if(options.decodeType.equals("proj")) {
		if(options.secondOrder)
		    d = ((DependencyDecoder2O)decoder).decodeProjectiveWithWeights(instance,fvs,probs,
									fvs_trips,probs_trips,
									fvs_sibs,probs_sibs,
									nt_fvs,nt_probs,K);
		else
	    ...
	    DependencyInstance newInstance =  new DependencyInstance(formsNoRoot, posNoRoot, labels, heads);
