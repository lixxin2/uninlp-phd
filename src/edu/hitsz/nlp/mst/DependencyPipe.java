...
import edu.hitsz.nlp.mst.io.DependencyWriter;
...
public class DependencyPipe {
    ...
    public Alphabet dataAlphabet; //特征map

    public Alphabet typeAlphabet; //依存关系map
