...
public class KneserNeyFromTextReaderTest
{
	...
	public static void main(String[] args) {
		...
		new KneserNeyFromTextReaderTest().testTrigram();
		/*
		String textFile = "/home/tm/windows/asr/lm/berkeleylm/1.text";
		String arpaFile = "/home/tm/windows/asr/lm/berkeleylm/1.arpa";
		new KneserNeyFromTextReaderTest().createKneserNeyLM(textFile, arpaFile, new double[] { 0.75f, 0.6f, 0.6f });
		*/
	...
	public void testBigram() {
		doTest("/home/tm/windows/asr/lm/berkeleylm/1", new double[] { 0.75f, 0.33333f });
	}

	@Test
	public void testTrigram() {
		doTest("/home/tm/windows/asr/lm/berkeleylm/1", new double[] { 0.75f, 0.6f, 0.6f });
	}
	...
	private void doTest(final String prefix, final double[] discounts) {
		...
		final String txtFile = new File(prefix + ".txt").getPath();
		final File goldArpaFile = new File(prefix + ".arpa");
	...
	public void createKneserNeyLM(final String textFile, final String arpaFile, final double[] discounts) {
		...
		//final TextReader<String> reader = new TextReader<String>(Arrays.asList(textFile), wordIndexer);
		//final KneserNeyLmReaderCallback<String> kneserNeyReader = new KneserNeyLmReaderCallback<String>(wordIndexer, order, opts);
		//reader.parse(kneserNeyReader);
		//kneserNeyReader.parse(new KneserNeyFileWritingLmReaderCallback<String>(new File(arpaFile), wordIndexer));
	
		LmReaders.createKneserNeyLmFromTextFiles(Arrays.asList(textFile), wordIndexer, order,
				new File(arpaFile), opts);
