...
public class POSOptions {
	...
	//"pos-en-collins":基于字符的
	public String modelType = "pos";
	...
	public POSOptions (String[] args) {
		for(int i = 0; i < args.length; i++) {
			...
			if (pair[0].equals("bestK")) {
				bestK = pair[1].equals("true") ? true : false;
			}
			...
			if (pair[0].equals("outK")) {
				outK = Integer.parseInt(pair[1]);
			}
