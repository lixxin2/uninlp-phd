...
public class DependencyFeatureVector implements Serializable {
	/**
	 *
	 */
	...
	public DependencyFeatureVector(){
		fv = new ArrayList<Integer>();
		sfv = new ArrayList<String>();
	}

    public DependencyFeatureVector (int[] keys) {
    	this();
    ...
    public void cat(DependencyFeatureVector fv2){
    	fv.addAll(fv2.fv);
    	sfv.addAll(fv2.sfv);
    }
