...
public class DependencyDecoder2OJoint extends DependencyDecoderJoint {

    public DependencyDecoder2OJoint(DependencyPipeJoint pipe) {
	super(pipe);
    }
	...
	orig[0][0] = ((DependencyPipe2OJoint)pipe).createFeatureVector(inst, true);
	orig[0][1] = pars;
